...
public class CategoryListAdapter extends BaseExpandableListAdapter {
    ...
    private HashMap<Integer, List<Category>> _listDataChild;

    public CategoryListAdapter(Context context, List<Category> listDataHeader,
                                 HashMap<Integer, List<Category>> listChildData) {
